...
base as (
    ...
    where (
      ...
      and (
         ...
         or (summary.subscribed_at is not null and (summary.subscribed_at at time zone 'Africa/Johannesburg')::date >= n.subscribed_from)
        )
      and (
            n.subscribed_to is null
         or (summary.subscribed_at is not null and (summary.subscribed_at at time zone 'Africa/Johannesburg')::date <= n.subscribed_to)
        )
      and (
