...
revoke all on function public.admin_subscribers_page(integer, integer, text, text, boolean, text, text, text, text, text, text, date, date, date, date) from public;
revoke all on function public.admin_subscribers_page(integer, integer, text, text, boolean, text, text, text, text, text, text, date, date, date, date) from anon;
revoke all on function public.admin_subscribers_page(integer, integer, text, text, boolean, text, text, text, text, text, text, date, date, date, date) from authenticated;
grant execute on function public.admin_subscribers_page(integer, integer, text, text, boolean, text, text, text, text, text, text, date, date, date, date) to service_role;
