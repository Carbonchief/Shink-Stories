drop function if exists public.admin_subscribers_page(integer, integer, text, text, boolean);
...
revoke all on function public.admin_subscribers_page(integer, integer, text, text, boolean, text, text, text, text, text, text) from public;
revoke all on function public.admin_subscribers_page(integer, integer, text, text, boolean, text, text, text, text, text, text) from anon;
revoke all on function public.admin_subscribers_page(integer, integer, text, text, boolean, text, text, text, text, text, text) from authenticated;
grant execute on function public.admin_subscribers_page(integer, integer, text, text, boolean, text, text, text, text, text, text) to service_role;
