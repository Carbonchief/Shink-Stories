...
public partial class App : Application
{
    ...
    private readonly MobileStoreRecoveryService _storeRecovery;

    public App(AppShell shell, MobileAppLifecycleService lifecycleService, MobileAnalyticsService analytics, MobileStoreRecoveryService storeRecovery)
    {
        InitializeComponent();
        _shell = shell;
        _lifecycleService = lifecycleService;
        _analytics = analytics;
        _storeRecovery = storeRecovery;
    }
