...
public sealed class KarakterRaaiConfigPage : ContentPage
{
    ...
    public KarakterRaaiConfigPage(StoryPlaybackSession storyPlaybackSession)
    {
        ...
        _playButton = new Button
        {
            ...
            AutomationId = "karakter-raai-play"
        };
    ...
    private (Grid Container, Border Card) BuildDifficultyCard(CharacterGuessDifficultyOption option)
    {
        ...
        SemanticProperties.SetDescription(card, $"Kies {option.DisplayName.ToLowerInvariant()}, {option.TotalRounds} rondtes");
    ...
    private async Task PlaySelectedDifficultyAsync()
    {
        ...
        try
        {
            ...
            {
                ["rounds"] = _selectedOption.TotalRounds
            };
